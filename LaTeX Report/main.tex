...
\section{Penrose Diagram}\label{appendix:penrose}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.99\linewidth]{images/Penrose.png}
    \caption{Expected Penrose diagram of the ER charged black hole spacetime. This figure is speculative and a detailed analysis is required to confirm it or not. The diagram was made with \href{https://tikz.net/relativity_penrose_diagram/}{Izaak Neutelings' template}.}
    \label{fig:penrose}
\end{figure}
